...
def build_prompt_datasettest(args,label_dict,map_dict,savefile):
    ...
    demofile = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/dicl/gpt2-xl/train/train_dicl_{args.task_name}.csv'
    dtext, dlabel = [], []
    ...
    with open(valid_file, mode='r') as csv_file:
        ...
        for row in csv_reader:
            ...
            if args.task_name=='imdb':
                prompts = [format_s.format(text=dtext[i][:2900], label=map_dict[int(dlabel[i])]) for i in range(len(dtext))]
            else:
...
def build_prompt_datasetvalid(args,map_dict,savefile):
    ...
    valid_file =f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/logitbased/sota/valid_dicl_{args.task_name}.csv'
    format_s_dict = {
        'sst2': 'Review: {text}\nSentiment:{label}',
        'imdb': 'Review: {text}\nSentiment:{label}',
        'glue-sst2100': 'Review: {text}\nSentiment:{label}',
    ...
    with open(valid_file, mode='r') as csv_file:
        ...
        for row in csv_reader:
            ...
            row = []
            if args.task_name == 'imdb':
                prompts = [format_s.format(text=dtext[i][:2900], label=map_dict[int(dlabel[i])]) for i in
                           range(len(dtext))]
            else:
                prompts = [format_s.format(text=dtext[i], label=map_dict[int(dlabel[i])]) for i in range(len(dtext))]
            inputs = format_s.format(text=text, label="")
...
for args.task_name in [
    ...
    for epoch in epochs:
        ...
        map_dict = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/dicl/llama3/{args.task_name}_logiticl_mapdict_{epoch}.json')
        candidate_map_dict = {int(k): ''.join(v) for k, v in map_dict.items()}
        train_save_path = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/temp/mdicl_llama3_{args.task_name}_{epoch}_test.csv'
        build_prompt_datasettest(args, label_dict, candidate_map_dict, train_save_path)
        select_save_path = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/dicl/llama3/test/select_{args.task_name}_{epoch}_test'
        acc, false_list_2 = evaluate(train_save_path, test_csv_path, multi_token, select_save_path, tokenizer, model, args)

        '''valid'''
        train_save_path = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/temp/llama3_logiticlselect_{args.task_name}_{epoch}_valid.csv'
        map_dict = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/dicl/llama3/{args.task_name}_logiticl_mapdict_{epoch}.json')
        candidate_map_dict = {int(k): ''.join(v) for k, v in map_dict.items()}
        build_prompt_datasetvalid(args, candidate_map_dict, train_save_path)
        select_save_path = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/dicl/llama3/valid/select_{args.task_name}_{epoch}_valid'
        acc, false_list_2 = evaluate(train_save_path, test_csv_path, multi_token, select_save_path, tokenizer, model,args)
        ...
        better_label = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/dicl/llama3/{args.task_name}_logiticl_mapdict_{epoch}.json')
        ...
        save_file = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/dicl/llama3/valid/select_{args.task_name}_{epoch}_valid'
        test_file =  f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/logitbased/sota/valid_dicl_{args.task_name}.csv'
        ...
        with open(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/dicl/llama3/{args.task_name}_logiticl_mapdict_{epoch+1}.json','w') as file:
