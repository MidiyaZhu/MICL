...
def build_prompt_datasettest(args,label_dict,map_dict,savefile,seed):
    random.seed(seed)
    test_dict = {}
    ...
    for label in label_dict:
        ...
        selected_integer = random.randint(0, len(dataset_trian) - 1)
        with open(retrieve_file, 'r') as file:
            # Load the data from the file
            verb_dict = json.load(file)
        for eg in verb_dict:
            if eg['text'] not in test_dict:
                test_dict[eg['text']] = {'class': eg['label'], 'text': [dataset_trian[selected_integer]['text']],
                                         'label': [dataset_trian[selected_integer]['label']]}
            else:
                if dataset_trian[eg['ctxs'][0]]['label'] not in test_dict[eg['text']]['label']:
                    test_dict[eg['text']]['text'].append(dataset_trian[selected_integer]['text'])
                    test_dict[eg['text']]['label'].append(dataset_trian[selected_integer]['label'])
...
def build_prompt_datasetvalid(args,map_dict,savefile,seed):
    random.seed(seed)
    test_dict = {}
    rows = [['text', 'labels', 'sentence', 'idx']]
    for label in label_dict:
  ...
  #  'ag_news', 'imdb'
    ...
    for seed in seeds:  #
        ...
        for epoch in epochs:
            ...
            if epoch==1:
                map_dict = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/vanilla/llama3/{args.task_name}_logiticl_mapdict_{epoch}.json')
            else:
                map_dict = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/vanilla/llama3/{args.task_name}_logiticl_mapdict_{epoch}_{seed}.json')
            candidate_map_dict = {int(k): ''.join(v) for k, v in map_dict.items()}
            train_save_path = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/temp/mvanilla_{args.task_name}_{epoch}_test_llama3.csv'
            build_prompt_datasettest(args, label_dict, candidate_map_dict, train_save_path,seed)
            select_save_path = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/vanilla/llama3/test/select_{args.task_name}_{epoch}_test_{seed}'
            acc, false_list_2 = evaluate(train_save_path, test_csv_path, multi_token, select_save_path, tokenizer, model, args)

            '''valid'''
            train_save_path = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/temp/vaselect_{args.task_name}_{epoch}_valid_llama3.csv'
            if epoch == 1:
                map_dict = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/vanilla/llama3/{args.task_name}_logiticl_mapdict_{epoch}.json')
            else:
                map_dict = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/vanilla/llama3/{args.task_name}_logiticl_mapdict_{epoch}_{seed}.json')
            candidate_map_dict = {int(k): ''.join(v) for k, v in map_dict.items()}
            build_prompt_datasetvalid(args, candidate_map_dict, train_save_path,seed)
            select_save_path = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/vanilla/llama3/valid/select_{args.task_name}_{epoch}_valid_{seed}'
            acc, false_list_2 = evaluate(train_save_path, test_csv_path, multi_token, select_save_path, tokenizer, model,args)
            if args.task_name=='trec':
                ...
                raw_verbalizer = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/verbalizer/basedonlogits/filter_low_quality/basedontrain/{args.task_name}_verbalizer_movelogit_rpb_llama3.json')
            if epoch == 1:
                better_label = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/vanilla/llama3/{args.task_name}_logiticl_mapdict_{epoch}.json')
            else:
                better_label = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/vanilla/llama3/{args.task_name}_logiticl_mapdict_{epoch}_{seed}.json')
            ...
            save_file = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/vanilla/llama3/valid/select_{args.task_name}_{epoch}_valid_{seed}'
            ...
            with open(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/vanilla/llama3/{args.task_name}_logiticl_mapdict_{epoch+1}_{seed}.json','w') as file:
