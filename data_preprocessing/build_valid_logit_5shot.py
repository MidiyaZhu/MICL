...
for method in ['method1']:#,'method2'
    for task_name in [
        ...
        file1_path = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/logitbased/train/logit_score/train_{task_name}_{method}_{model_name}_5shots.csv'
        output_path =  f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/logitbased/train/logit_score/valid_{task_name}_{method}_{model_name}_5shots.csv'
