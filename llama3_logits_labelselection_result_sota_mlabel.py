...
for method in ['dicl','topk','selficl']:#'topk','selficl''dicl','method2','method3',,'vanilla','topk','selficl',
    for args.task_name in [
        ...
        if 'gpt' in args.model_name.lower():
            save_file = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/{method}/gpt2xl/new/test/select_{args.task_name}_{epoch}_test'
            raw_label_map = get_label_dict_gpt2xl(args.label_dict, tokenizer, args)
        elif 'llama-3' in args.model_name.lower():
            save_file = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/{method}/llama3/test/select_{args.task_name}_{epoch}_test'
            raw_label_map = get_label_dict_gpt2xl(args.label_dict, tokenizer, args)
        else:
            save_file = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/{method}/llama7b/test/select_{args.task_name}_{epoch}_test'
        ...
        for epoch in range(2,7):
            ...
            if 'gpt' in args.model_name:
                map_dict = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/{method}/gpt2xl/new/{args.task_name}_logiticl_mapdict_{epoch}.json')
                print(map_dict)
                label_map = get_label_dict_gpt2xl(map_dict, tokenizer, args)
                save_file = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/{method}/gpt2xl/new/test/select_{args.task_name}_{epoch}_test'
            elif 'llama-3' in args.model_name.lower():
                map_dict = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/{method}/llama3/{args.task_name}_logiticl_mapdict_{epoch}.json')
                print(map_dict)
                label_map = get_label_dict_llama3(map_dict, tokenizer, args)
                save_file = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/{method}/llama3/test/select_{args.task_name}_{epoch}_test'

            else:
                map_dict = load_jsonresult(f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/{method}/llama7b/{args.task_name}_logiticl_mapdict_{epoch}.json')
                print(map_dict)
