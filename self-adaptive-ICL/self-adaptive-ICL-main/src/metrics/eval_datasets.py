...
@app.add("isear")
def add_isear_acc(file_name, id_list=None):
    return add_sst2_acc(file_name=file_name, id_list=id_list, task_name="isear")

@app.add("aman")
def add_aman_acc(file_name, id_list=None):
    return add_sst2_acc(file_name=file_name, id_list=id_list, task_name="aman")
