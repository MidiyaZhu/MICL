...
def get_mapping_token0(task_name):
    if task_name == 'sst2' or task_name == 'yelp_polarity' or task_name == 'cr' or task_name == "imdb":
    ...
    if task_name == 'isear':
        return isear_map_token
    if task_name == 'aman':
        return aman_map_token
    # if task_name == 'cr':
    #     return cr_map_token
    return None
...
isear_map_token = {0:'fear',1:'sadness',2:'disgust',3:'anger',4:'joy',5:'guilt',6:'shame'}
aman_map_token = {0:'fear',1:'sadness',2:'disgust',3:'anger',4:'joy',5:'surprise',6:'others'}
# cr_map_token = {0:' negative',1:' positive'}
