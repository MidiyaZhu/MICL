...
def get_template(task_name, t=1):
    if t == 1:
        if task_name == "sst2" or task_name == "imdb":
            ...
            # return {
            #     0: {
            #         "example_instruction": "\"<X>\" It is fear.",
            #         "prompting_instruction": "<E>\"<X>\" It is fear.",
            #     },
            #     1: {
            #         "example_instruction": "\"<X>\" It is sadness.",
            #         "prompting_instruction": "<E>\"<X>\" It is sadness.",
            #     },
            #     2: {
            #         "example_instruction": "\"<X>\" It is disgust.",
            #         "prompting_instruction": "<E>\"<X>\" It is disgust.",
            #     },
            #     3: {
            #         "example_instruction": "\"<X>\" It is anger.",
            #         "prompting_instruction": "<E>\"<X>\" It is anger.",
            #     },
            #     4: {
            #         "example_instruction": "\"<X>\" It is joy.",
            #         "prompting_instruction": "<E>\"<X>\" It is joy.",
            #     },
            #     5: {
            #         "example_instruction": "\"<X>\" It is surprise.",
            #         "prompting_instruction": "<E>\"<X>\" It is surprise.",
            #     },
            #     6: {
            #         "example_instruction": "\"<X>\" It is others.",
            #         "prompting_instruction": "<E>\"<X>\" It is others.",
            #     }
            # }
        elif task_name == "aman":
            return {
                ...
                5: {
                    "example_instruction": "\"<X>\" It is guilt.",
                    "prompting_instruction": "<E>\"<X>\" It is guilt.",
                },
                6: {
                    "example_instruction": "\"<X>\" It is shame.",
                    "prompting_instruction": "<E>\"<X>\" It is shame.",
                }
            }
        elif task_name == "cr":
            return {
                0: {
                    "example_instruction": "\"<X>\" It is negative.",
                            "prompting_instruction": "<E>\"<X>\" It is negative.",
                },
                1: {
                    "example_instruction": "\"<X>\" It is positive.",
                    "prompting_instruction": "<E>\"<X>\" It is positive.",
                }
            }
