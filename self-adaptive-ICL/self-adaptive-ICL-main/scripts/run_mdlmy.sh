...
export WANDB_ENTITY=zixiaozhu  # change to your wandb account
export WANDB_API_KEY=08231f47d978105125589d4ff268a928417cd933  # change to your api-key
export WANDB_START_METHOD=thread
export TOKENIZERS_PARALLELISM=false

export HYDRA_FULL_ERROR=1

root=/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/self-adaptive-ICL/self-adaptive-ICL-main/ # change to your path
num_ice=8
num_candidates=30
...
emb_field=X # or ALL
n_gpu=1
test_path='/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/self-adaptive-ICL/self-adaptive-ICL-main/data/isear.csv'
for task_name in isear
do
  ...
  python prerank.py output_file=${retrieve_file} \
      ...
      scale_factor=0.1\
      cfg.dataset_reader.dataset_path=${test_path}
