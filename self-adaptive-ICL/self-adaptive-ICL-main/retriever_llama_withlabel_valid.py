    ...
    for seed in [1]:
        for task_name in [
            ...
            for key in label_dict:
                ...
                emb_field = "X"
                n_gpu = 1
                run_dir = os.path.join(root, f'output/{task_name}/valid/{seed}/')
                retrieve_file = os.path.join(run_dir, f'retrieved{key}.json')
                retrieve_file2 = os.path.join(run_dir, f'retrieved2{key}2.json')
                ...
                cfg.dataset_reader.index_data_path =f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/train/train_{task_name}_{seed}_{key}.csv'
