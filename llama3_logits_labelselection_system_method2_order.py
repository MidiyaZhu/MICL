...
for method in ['method2']:  #,'method2'
    ...
    for args.task_name in tasknames:
        ...
        for epoch in epochs:
            ...
            train_save_path = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/temp/iticlelect_{args.task_name}_{epoch}_{method}_test_order.csv'
            ...
            if epoch == 1:
                ...
                map_dict = load_jsonresult( f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/results/logitbased/1shot/labelselect/micl/llama3/{args.task_name}_logiticl_mapdict_{method}_order_{epoch}_llama3.json')
            candidate_map_dict = {int(k): ''.join(v) for k, v in map_dict.items()}
            train_save_path = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/temp/iticlelect_{args.task_name}_{method}_{epoch + 1}_valid_order.csv'
    ...
    #         candidate_map_dict = {int(k): ''.join(v) for k, v in map_dict.items()}
    #         train_save_path = f'/mnt/e72cc1a3-e45e-4a0c-b1e6-0e4357d2e753/zixiao/RAG/label-words-are-anchors-main/data/new/temp/iticl_{args.task_name}_{method}_{epoch}_test.csv'
